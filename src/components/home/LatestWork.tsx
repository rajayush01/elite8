...
// 					const newIndex = Math.min(Math.floor(exactProgress), projects.length - 1);
...
// 		const opacity = 1 - easeProgress * 0.5; // Changed from 0.95 to 0.5 - ab video 50% opacity tak rahega
...
// 				<div className="mb-12">
// 					<h2 className="text-5xl font-bold text-white mb-2 animate-fade-in-up">LATEST WORK</h2>
// 				</div>
...
// 						>
// 							<div className="relative overflow-hidden rounded-lg aspect-square w-full max-w-md mx-auto">
// 								<video
// 									src={project.video}
...
// 						<h2 className="text-7xl mb-4 text-center font-bold text-white">LATEST WORK</h2>
// 					</div>
...
// 										}}
// 									>
// 										<h4 className="text-6xl font-bold text-white">{project.title}</h4>
...
// 						{/* Right Side - Videos - 3/5 width */}
// 						<div className="w-3/5 relative h-[550px] overflow-visible flex items-center justify-center">
...
// 												transition:
// 													'transform 1.4s cubic-bezier(0.25, 0.1, 0.25, 1), opacity 1s ease-out',
...
import gsap from 'gsap';
import { ScrollTrigger } from 'gsap/ScrollTrigger';
import img1 from '../../assets/nymara1.png';
