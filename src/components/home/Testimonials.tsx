		...
		<div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
			<div className="max-w-7xl w-full">
				...
				<div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-10">
					...
					>
						<div className={isMobile ? 'flex gap-4 sm:gap-6 h-full items-start' : 'space-y-4 sm:space-y-6'}>
							{doubledTestimonials.map((testimonial, index) => (
								<div
									key={`${testimonial.id}-${index}`}
									className={`bg-white/10 backdrop-blur-lg rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 ${isMobile ? 'flex-shrink-0 w-[300px] sm:w-[350px]' : ''}`}
								>
									<div className="flex sm:flex-col flex-col items-start gap-3  sm:gap-4">
										<div className="flex gap-3">
											...
											/>
											<p className="text-white text-xl sm:hidden pt-2">{testimonial.name}</p>
										</div>
										...
										<div className="flex-1 min-w-0">
											...
											<div>
												...
												<p className="text-purple-300 text-xs sm:text-sm">{testimonial.role}</p>
											</div>
										</div>
									</div>
								</div>
